     ...
     <input type="text" className="form-control" id="name" placeholder="NAME" name="name"  />
      ...
      <div className="direct-contact-container">
        ...
        <ul className="contact-list">
          ...
          <li className="list-item"><i className="fa fa-phone fa-2x"><span className="contact-text phone"><a href="tel" title="Give me a call">+254 792487814</a></span></i></li>
          
          <li className="list-item"><i className="fa fa-envelope fa-2x"><span className="contact-text gmail"><a href="mailto:#" title="Send me an email">fxprime@gmail.com</a></span></i></li>
